(function (global, factory) {
    ...
    */
    ...
    var color = {
        ...
        color: function(name) {
            if (name || color_dict[name]) return color_dict[name].nicer
            return this.hex()
        },
        // #DAC0DE
        hex: function() {
            var hsv = this._goldenRatioColor();
            var rgb = color_convert.hsv2rgb(hsv);
            var hex = color_convert.rgb2hex(rgb[0], rgb[1], rgb[2]);
            return hex
        },
        // rgb(128,255,255)
        rgb: function() {
        ...
        hsl: function() {
            var hsv = this._goldenRatioColor();
            var hsl = color_convert.hsv2hsl(hsv);
            return 'hsl(' +
                parseInt(hsl[0], 10) + ', ' +
                parseInt(hsl[1], 10) + ', ' +
                parseInt(hsl[2], 10) + ')'
    ...
    */
    ...
    var address = {
        ...
        province: function() {
            return this.pick(address_dict).name
        },
        // 随机生成一个（中国）市。
        city: function(prefix) {
            var province = this.pick(address_dict);
    ...
    */
    ...
    function valid$1(template, data) {
        var schema$1 = schema(template);
        var result = Diff.diff(schema$1, data);
